...
void CAntiAim::do_antiaim(SDK::CUserCmd* cmd)
{
	...
	else if ((local_player->GetVelocity().Length2D() > 80) && (!(cmd->buttons & IN_JUMP) && (local_flags & FL_ONGROUND)))
	{
		...
		if (GLOBAL::should_send_packet)
		{
			...
			{
			case 0: break;
			case 1: cmd->viewangles.y += 180.000000 + ((rand() % 15) - (15 * 0.5f)) + SETTINGS::settings.aa_fakeadditive1_val; break;
		...
		else
		{
			...
			{
			case 0: break;
			case 1: cmd->viewangles.y += 179.000000f + SETTINGS::settings.aa_realadditive1_val; break;
	...
	else
	{
		...
		if (GLOBAL::should_send_packet)
		{
			...
			{
			case 0: break;
			case 1: cmd->viewangles.y += 180.000000 + ((rand() % 15) - (15 * 0.5f)) + SETTINGS::settings.aa_fakeadditive2_val; break;
		...
		else
		{
			...
			{
			case 0: break;
			case 1: cmd->viewangles.y += 179.000000f + SETTINGS::settings.aa_realadditive2_val; break;
