...
namespace SDK
{
	...
	enum ItemDefinitionIndex : short
	{
		...
		WEAPON_C4 = 49,
		WEAPON_KNIFE_T = 59,
		WEAPON_M4A1_SILENCER = 262204,              //60
		WEAPON_USP_SILENCER = 262205,               //61
		WEAPON_CZ75A = 63,
		WEAPON_REVOLVER = 64,
	...
	public:
		...
		void SetAbsAngles2(QAngle angles)
		{
			using Fn = void(__thiscall*)(CBaseEntity*, const QAngle &angles);
			static Fn func;
		...
		CBaseHandle* GetWearables()
		{
			...
			return reinterpret_cast<CBaseHandle*>(this + OFFSETS::m_hMyWearables);
		}
		int GetHealth()
		{
	...
	public:
		...
		{                                       //int
			return (short*)((DWORD)this + 0x00002D70 + 0x00000040 + 0x000001D8);
		}
